...
- 既存の管理アプリでは情報が管理しきれない作者:
  私自身この層に当てはまります。既存の管理アプリの多くは自由記述が多く、使いたい情報を調べるときに記載している情報が多く、頭になかなかはいてこない傾向があると考えています。
  本アプリでは自由記述はプロットの構成メモにしぼり、他情報は基本的に箇条書きスタイルにすることで、見返したときに情報が理解しやすくなるような設計を考えています。
...
- [] 一覧機能 (ストーリー、プロット、ワールドガイド、キャラクター、フラグ)
- [] 手動保存機能 (ストーリー、プロット、ワールドガイド、キャラクター、フラグ)
- [] フラグ作成・回収管理機能
...
■ ER図
https://drive.google.com/file/d/1HUQCqgzlIbGiE9C-4NPgN5kA-7T0zBcv/view?usp=sharing
